...
public class CustomerBookingsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CustomerBookingsAdapter(Context context, List<CustomerRequest> items) {
        this.items = items;
        this.ctx = context;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        mDatabase.child("users").child("drivers").child(s.getDriver_uid()).addValueEventListener(new ValueEventListener() {
            @Override
